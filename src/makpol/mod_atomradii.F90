...
!
!.. Global Arrays ..
    integer, parameter :: periodic_table_length = 106
...
!
!  Change radii to ensure that bonding is correct.
!  Ti reset.  Was: 2.26
!      H       He
         & 1.20d0, 1.40d0, &
!
!      Li      Be      B       C       N       O       F       Ne
         & 0.5d0, 1.87d0, 1.69d0, 1.70d0, 1.55d0, 1.52d0, 1.47d0, 1.54d0, &
!
!      Na      Mg      Al      Si      P       S       Cl      Ar
         & 0.5d0, 1.73d0, 2.06d0, 2.10d0, 1.80d0, 1.80d0, 1.75d0, 1.88d0, &
!
!      K       Ca      Sc      Ti      V       Cr      Mn      Fe
         & 0.5d0, 2.17d0, 2.26d0, 1.7d0, 2.15d0, 2.05d0, 2.10d0, 2.06d0, &
...
!      Rb      Sr      Y       Zr      Nb      Mo      Tc      Ru
         & 0.5d0, 2.94d0, 2.90d0, 2.85d0, 2.80d0, 2.20d0, 2.20d0, 2.20d0, &
...
!      Cs      Ba      La      Ce      Pr      Nd      Pm      Sm
         & 0.5d0, 2.97d0, 2.40d0, 2.40d0, 2.40d0, 2.40d0, 2.40d0, 2.40d0, &
