...
!
!     The functions ilaenv and ieeeck are part of LAPACK and return
!     system specific parameters. This file contains machine specific
!     code for these two functions (separated by cpp preprocessor
!     directives). It may be changed to optimize for different platforms
!     or to prevent platform specific bugs.
!
!     For production code, vendor-supplied BLAS and LAPACK libraries should
!     be used instead of the source code in this directory.
!
